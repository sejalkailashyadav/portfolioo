...
import profilePic from "./sejal.png"; 
...
const HomeSection1 = ({ id }: Readonly<{ id: string }>) => {
  ...
  <Image
    src={profilePic} // or "/sejal.png" if in public
    alt="Sejal Yadav"
    width={250}
    height={150}
  ...
  />
          ...
          <div className="mt-1 gap-4 lg:mt-5 flex flex-col md:flex-row">
            <TalkButton />
          </div>
        </Column>


        <div className="mt-1 lg:mt-5 w-full flex flex-col items-center">
