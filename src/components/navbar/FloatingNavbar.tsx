    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <Row>
           {/* Resume button */}
  <a
    href="https://drive.google.com/file/d/1BSeny94xsPZkfyEUMfT9lD9kvJf7IMQy/view?usp=sharing"
    download
    className="px-4 py-2 rounded-full bg-[var(--primaryColor)] text-white font-medium hover:opacity-90 transition"
  >
    Resume
  </a>
        </Row>
